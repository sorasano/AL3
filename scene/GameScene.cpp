...
void GameScene::Update() {
	...
	{
		//上半身の回転速さ[ラジアン/flame]
		const float kCestRotSpeed = 0.05f;

		//押した方向で移動ベクトルを変更
		if (input_->PushKey(DIK_U)) {
			worldTransform_[PartId::Chest].rotation_.y -= kCestRotSpeed;
	...
	//
	// debugText_->SetPos(50, 110);
	// debugText_->Printf("scale_:(%f,%f,%f)", worldTransform_.scale_.x, worldTransform_.scale_.y,
